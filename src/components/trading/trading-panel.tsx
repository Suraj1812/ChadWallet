      ...
      <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-5">
        <div className="mb-5 flex items-center justify-between">
          <div>
            ...
            <h2 className="text-2xl font-black tracking-[-0.04em]">Buy & sell</h2>
          </div>
        ...
        <div className="grid grid-cols-2 rounded-full bg-black/40 p-1">
          {(["buy", "sell"] as const).map((option) => (
            <button
              className={cn(
                "rounded-full px-4 py-3 text-sm font-black uppercase tracking-[0.16em] transition",
                side === option
                  ? option === "buy"
        ...
        <label className="mt-5 block rounded-3xl border border-white/10 bg-black/30 p-4">
        ...
        <button
          className={cn(
            "mt-5 w-full rounded-full px-5 py-4 text-sm font-black uppercase tracking-[0.16em] text-black transition hover:-translate-y-0.5",
        ...
        <div className="mt-4 grid gap-3">
          ...
          <div className="rounded-3xl border border-white/10 bg-black/25 p-4">
            <div className="flex items-center justify-between">
              ...
              <span className={cn("font-mono text-xs", rpcStatus.configured ? "text-chad" : "text-white/45")}>
